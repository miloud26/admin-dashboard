...
const EditCoupon = () => {
  ...
  useEffect(() => {
    const getSingleProduct = async () => {
      const data = await fetch(`http://localhost:1337/api/coupons/${id}`, {
        method: "GET",
        headers: {
      ...
      const { code, discount } = productData.data.attributes;
    ...
    >
      ...
      >
        <Header
          ...
          slug="You can edit Coupon that you like here and that suit your work"
        />
      </Box>
      <Box
        width="100%"
